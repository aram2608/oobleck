...
typedef bool (*UmkaInit)(Umka* umka, const char* fileName,
                         const char* sourceString, int stackSize,
                         void* reserved, int argc, char** argv,
...
typedef bool (*UmkaAddModule)(Umka* umka, const char* fileName,
                              const char* sourceString);
typedef bool (*UmkaAddFunc)(Umka* umka, const char* name, UmkaExternFunc func);
typedef bool (*UmkaGetFunc)(Umka* umka, const char* moduleName,
                            const char* fnName, UmkaFuncContext* fn);
typedef bool (*UmkaGetCallStack)(Umka* umka, int depth, int nameSize,
                                 int* offset, char* fileName, char* fnName,
                                 int* line);
...
typedef void (*UmkaMakeDynArray)(Umka* umka, void* array, const UmkaType* type,
                                 int len);
...
typedef void (*UmkaMakeFuncContext)(Umka* umka, const UmkaType* closureType,
                                    int entryOffset, UmkaFuncContext* fn);
typedef UmkaStackSlot* (*UmkaGetParam)(UmkaStackSlot* params, int index);
typedef UmkaAny* (*UmkaGetUpvalue)(UmkaStackSlot* params);
typedef UmkaStackSlot* (*UmkaGetResult)(UmkaStackSlot* params,
                                        UmkaStackSlot* result);
...
typedef const UmkaType* (*UmkaGetResultType)(UmkaStackSlot* params,
                                             UmkaStackSlot* result);
typedef const UmkaType* (*UmkaGetFieldType)(const UmkaType* structType,
...
UMKA_API bool umkaInit(Umka* umka, const char* fileName,
                       const char* sourceString, int stackSize, void* reserved,
                       int argc, char** argv, bool fileSystemEnabled,
...
UMKA_API bool umkaAddModule(Umka* umka, const char* fileName,
                            const char* sourceString);
UMKA_API bool umkaAddFunc(Umka* umka, const char* name, UmkaExternFunc func);
UMKA_API bool umkaGetFunc(Umka* umka, const char* moduleName,
                          const char* fnName, UmkaFuncContext* fn);
UMKA_API bool umkaGetCallStack(Umka* umka, int depth, int nameSize, int* offset,
...
UMKA_API void umkaMakeDynArray(Umka* umka, void* array, const UmkaType* type,
                               int len);
...
UMKA_API void umkaMakeFuncContext(Umka* umka, const UmkaType* closureType,
                                  int entryOffset, UmkaFuncContext* fn);
UMKA_API UmkaStackSlot* umkaGetParam(UmkaStackSlot* params, int index);
UMKA_API UmkaAny* umkaGetUpvalue(UmkaStackSlot* params);
UMKA_API UmkaStackSlot* umkaGetResult(UmkaStackSlot* params,
                                      UmkaStackSlot* result);
...
UMKA_API const UmkaType* umkaGetResultType(UmkaStackSlot* params,
                                           UmkaStackSlot* result);
UMKA_API const UmkaType* umkaGetFieldType(const UmkaType* structType,
                                          const char* fieldName);
